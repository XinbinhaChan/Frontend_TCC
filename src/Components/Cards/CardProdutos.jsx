...
export function CardProdutos(props) {
  return (
    <div className='w-fit ml-2 mb-10' data-aos="zoom-in">
        ...
        <div className='w-30 md:w-[634px] md:h-[444px] h-20 flex items-center justify-center rounded-t-3xl border-2 border-fundo-card dark:border-dark-nav'>
          <img src={props.img} alt="" className='w-20 h-20 md:w-[350px] md:h-[268px]'/>
        </div>

        <div className=' bg-fundo-card dark:bg-dark-nav p-2 rounded-b-3xl md:h-[176px]'>
